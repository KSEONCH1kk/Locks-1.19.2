...
public final class LocksCommonConfig {
    ...
    static {
        ...
        GENERATED_LOCKS = cfg
                ...
                .defineList("Generated Locks", Lists.newArrayList("locks:wood_lock", "locks:iron_lock", "locks:steel_lock", "locks:gold_lock", "locks:diamond_lock", "locks:netherite_lock"), e -> e instanceof String);
